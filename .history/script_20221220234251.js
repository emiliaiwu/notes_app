...
const addNote = () => {
    ...
    note.innerHTML = `
        <div class="note addNote">
            <textarea class="textarea">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Amet voluptas incidunt id voluptatibus dicta excepturi officiis error maxime fuga numquam!
                    </textarea>
                    <div class="footer close">
                        <div class="date">Dec 18, 2022</div>
